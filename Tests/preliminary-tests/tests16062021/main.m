...
num = 4;
time_file = sprintf("time0%d.txt", num);
data_file = sprintf("data0%d.txt", num);
yaw_plot = sprintf("plots/yaw0%d.pdf", num);
pitch_plot = sprintf("plots/pitch0%d.pdf", num);
roll_plot = sprintf("plots/roll0%d.pdf", num);
all_plot = sprintf("plots/all0%d.pdf", num);
